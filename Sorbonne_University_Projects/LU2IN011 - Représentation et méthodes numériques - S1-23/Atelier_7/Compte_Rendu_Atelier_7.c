...
Dans ce cas, il converge rapidement vers 1.
...
Dans ce cas, il converge vers 3.5.
On lance le programme et les resultat sont:
...
Dans ce cas, il converge rapidement vers -2.
...
Dans ce cas, il converge initialement vers 1 , mais il devient instable à partir de l'itération 52.
x0 : 2.000000000000000e+00
...
En résumé:
1. Pour x0 = 2, α = 0.3, ε = 10ˆ(-14) , la méthode de Horner converge rapidement vers une solution très proche de 1.
2. Pour x0 = 5, α = 3.5, ε = 10ˆ(-14): , la méthode de Horner converge rapidement vers une solution très proche de 3.5.
3. Pour x0 = 0.5, α = 3.5, ε = 10ˆ(-14): , la méthode de Horner converge rapidement vers une solution très proche de 1.
4. Pour x0 = -3.0, α = 1.0, ε = 10ˆ(-14): , la méthode de Horner converge rapidement vers une solution très proche de -2.
5. Pour x0 = 2.0, α = 1.0, ε = 10ˆ(-14): , la méthode de Horner converge initialement vers 1, mais devient instable à partir de l'itération 52, produisant un résultat indéfini (-nan).
