...
//Declarer les parametres globaux de l'ecosysteme suivants pour avoir le droit d'utiliser directement les noms des parametres dans les fonction dans ecosys.c
